...
**Source**: The Data Center analysis of IPUMS NHGIS data from 1980, 1990, 2000, and 2010 Decennial Census and US Census Bureau data from the American Community Survey `r yearPEP`."
)
```
...
include_graphics("indicator expansion drafts/graphics/medhh.hist.png")
```
```{r, echo=FALSE}
makeCSS_source(
"**Notes**: The number of Asians in New Orleans during the timespan of this chart is too small to produce reliable statistics.
...
**Source**: The Data Center analysis of U.S. Census Bureau data from Census 2000 SF1 and American Community Survey `r yearPEP`."
)
```
...
include_graphics("indicator expansion drafts/graphics/homeownership.raceGeos.png")
```
```{r, echo=FALSE}
makeCSS_source(
...
America’s aging housing stock represents both a potential problem and an opportunity. Older homes are less energy-efficient and more expensive to maintain.[^14] Moreover, research has shown that lead poisoning in children is correlated strongly with residing in pre-1950 homes.[^15] Conversely, in New Orleans, many older homes are protected by preservation laws that have helped retain the historic character of the city.
...
[^7]: Vigdor J. and Ladd, H. (2010). Scaling the Digital Divide: Home Computer Technology and Student Achievement. Retrieved February 8, 2019 from http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.849.6663&rep=rep1&type=pdf.

[^8]: SPM***

[^9]: Difference between Black and Hispanic not statistically significant at a 95% confidence level.

[^10]: De Jong, G.F., Graefe, D.R., Hall, M., and Singer, A. (2001). The geography of immigrant skills: Educational profiles of metropolitan areas. Retrieved February 8, 2019 from https://www.brookings.edu/research/the-geography-of-immigrant-skills-educational-profiles-of-metropolitan-areas/.
...
[^17]: Davis, B., Dutzik, T. (2012). Transportation and the New Generation: Why Young People Are Driving Less and What It Means for Transportation Policy. Retrieved October 10, 2014 from http://www.uspirg.org/sites/pirg/files/reports/Transportation%20%26%20the%20New%20Generation%20vUS_0.pdf.

[^18]: The League of American Bicyclists. (2017). Where We Ride: Analysis of Bicycle Commuting in American Cities. Retrieved December 21, 2018 from https://bikeleague.org/sites/default/files/Where_We_Ride_2017_KM_0.pdf
