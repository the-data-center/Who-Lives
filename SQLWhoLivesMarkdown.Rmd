...
The number of African Americans living in New Orleans grew every year post-Katrina (from 2006 to 2018) but decreased for the first time post-Katrina from `r comma(AA2018)` in 2018 to `r comma(AA2018)` in 2018.
...
Like the overall poverty rate, the child poverty rate in New Orleans is statistically unchanged from 1999. In Jefferson Parish, the child poverty rate jumped from `r round((getvalue.childpov.jeff.1999)*100)` percent in 1999 to `r round((getvalue.childpov.jeff.2018)*100)` percent in `r yearu2` — greatly surpassing the U.S. child poverty rate, which rose from `r  round((getvalue.childpov.us.1999)*100)` to `r  round((getvalue.childpov.us.2018)*100)` percent between 1999 and `r yearu2`.
...
Homeownership rates across the U.S. have fallen since 2000 from `r round((getvalue.ho.us.2000)*100)` to `r round((getvalue.ho.us.2018)*100)` percent in `r yearu2`. Homeownership rates have decreased slightly in St. Tammany from `r round((getvalue.ho.tam.2000)*100)` percent to `r round((getvalue.ho.tam.2018)*100)` and in Jefferson from `r round((getvalue.ho.jeff.2000)*100)` to `r round((getvalue.ho.jeff.2018)*100)` percent between 2000 and `r yearu2`. In contrast, homeownership rates in New Orleans have held steady, but at a much lower `r round((getvalue.ho.no.2018)*100)` percent.
