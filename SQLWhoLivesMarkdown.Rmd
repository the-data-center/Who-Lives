...
Homeownership rates across the U.S. have fallen since 2000 from `r round((getvalue.ho.us.2000)*100)` to `r round((getvalue.ho.us.2018)*100)` percent in `r yearu2`. Homeownership rates have held steady in St. Tammany around `r round((getvalue.ho.tam.2000)*100)` percent since 2000. In contrast, homeownership rates in New Orleans have increased slightly, but still are a much lower `r round((getvalue.ho.no.2018)*100)` percent.
