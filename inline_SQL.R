...
#The U.S. Census Bureau estimates that 1,275,762 residents were living in metro New Orleans Parish as of July 2017
...
getvalue.pop.bernard.2017 <- Overallpop %>% 
  filter(PlaceName == "Da Parish (St. Bernard)") %>% 
  select(population) %>% 
  pull()
...
#According to the U.S. Census Bureau’s 2017 population estimates, there are now 91,274 fewer African Americans living in New Orleans Parish (Orleans Parish Parish) 

Overallpop2010 <- allparishesRawx %>% 
...
#In Orleans Parish Parish, the share of the 2017 population that is African American — while lower than in 2000 when it was 66.7 percent — 
...
#Meanwhile, Hispanic, Asian, and African American populations increased as a share of the total population in Jefferson Parish, Da Parish (St. Bernard), St. Charles Parish, St. John The Baptist Parish, and St. Tammany Parish parishes, each. 
#In fact, the number and share of Hispanics have increased in all eight parishes in the metro area.


#Between 2000 and 2017, the number of Hispanics in Jefferson Parish Parish increased by 33,163 
...
#such that the Hispanic share of the population was 5.7 percent in Orleans Parish and 5.8 percent in St. Tammany Parish by 2017.
...
#and indeed the whole country — with many more changes yet to come.[4] Looking at the total population in the metro by five-year AgeGroupName groups for 2000 and 2017, 
